# To run on 16 EMR nodes:
# python similar_movies_cosine_1m.py -r emr --num-ec2-instances=16 --items=../ml-1m/movies.dat ../ml-1m/ratings.dat > ../Data/output/similarity-16-nodes.txt
